...
internal class EncryptMego : IEncryptMego
{
    ...
    public async Task<string> Encrypt ( string str_login, string str_password, string str_id_transaccion )
    {
        ...
        HashCobis hashCobis = await _httpService.PostRestServiceDataAsync<HashCobis>(str_data, _settings.servicio_encrypt+"prb", String.Empty, String.Empty, String.Empty, str_id_transaccion, false);
